    ...
    d.prototype = {
        _init: function () {
            ...
            if ("undefined" != typeof h)
                for (var i = 0; i < h.length; i++) {
                    var j =
                        h[i].substring(0, 1).toLowerCase() +
                        h[i].substring(1) +
                        "Defaults";
                    "undefined" != typeof this[j] &&
                        b.extend(this.defaults, this[j]);
                }
            if (
                ...
                for (var k = 0; k < h.length; k++)
                    "undefined" != typeof this["init" + h[k]] &&
                        this["init" + h[k]]();
            if (
        ...
        update: function () {
            ...
            for (var d = this.slides.length - 1; d >= 0; d--)
                if (
                    0 ===
                    this.$slider.find('.sp-slide[data-index="' + d + '"]')
                        .length
                ) {
                    var e = this.slides[d];
                        ...
                        "undefined" != typeof b && b === !0
                            ...
                            : (this.$slides.addClass("sp-animated"),
                              (f =
                                  ...
                                  "s"),
                              this.$slides.on(this.transitionEvent, function (
                                  a
                              ) {
                ...
                : this.$slidesMask
                      ...
                      .animate(
                          ...
                          function (a) {
                              c.trigger({ type: "resizeHeightComplete" }),
                                  b.isFunction(
                                      c.settings.resizeHeightComplete
                                  ) &&
                                      c.settings.resizeHeightComplete.call(c, {
                                          type: "resizeHeightComplete",
                                      });
    ...
    (e.prototype = {
        _init: function () {
            this.$slide.attr("data-init", !0),
                ...
                (this.hasImages =
                    0 !== this.$slide.find("img").length ? !0 : !1);
        },
            ...
            d = {
                    ...
                    this.$slides.find(".sp-thumbnail").each(function (c) {
                        ...
                        0 !== d.parent("a").length && (d = d.parent("a")),
                            e > f
                                ...
                                : d.insertBefore(
                                      a.$thumbnails.find(".sp-thumbnail").eq(e)
                                  );
                    });
                            ...
                            "css-3d" === this.supportedAnimation
                                ...
                                "undefined" != typeof c && c === !0
                                    ...
                                    : (this.$thumbnails.addClass("sp-animated"),
                                      (g =
                                          this.vendorPrefix + "transform 0.7s"),
                                      this.$thumbnails.on(
                                          ...
                                          function (a) {
                                              a.target === a.currentTarget &&
                                                  ...
                                                  b.isFunction(
                                                      ...
                                                      e.settings.thumbnailsMoveComplete.call(
                                                          e,
                                                          {
                                                              type:
                                                                  "thumbnailsMoveComplete",
                ...
                _stopThumbnailsMovement: function () {
                    ...
                    if (
                        ...
                        var b = this.$thumbnails.css(
                                this.vendorPrefix + "transform"
                            ),
                            c =
                                -1 !== b.indexOf("matrix3d")
                                    ? "matrix3d"
                                    : "matrix",
                            d = b.replace(c, "").match(/-?[0-9\.]+/g),
                            e =
            ...
            setSize: function (a, b) {
                (this.width = a),
                    ...
                    this.$thumbnail.is("img") &&
                        "undefined" ==
                            typeof this.$thumbnail.attr("data-src") &&
                        this.resizeImage();
            },
            getSize: function () {
                return {
            ...
            getPosition: function () {
                return {
                    left:
                        ...
                        parseInt(
                            this.$thumbnailContainer.css("marginLeft"),
                            10
                        ),
                    right:
                        this.$thumbnailContainer.position().left +
                    ...
                    bottom:
                        this.$thumbnailContainer.position().top +
                        parseInt(
                            this.$thumbnailContainer.css("marginTop"),
                            10
                        ) +
                                ...
                                "undefined" !=
                                    ...
                                    "" !== e &&
                                        "undefined" ==
                                            typeof c.attr("data-src") &&
                                        c.attr("src") !== e &&
                                        a._loadConditionalImage(c, e, function (
                                            a
                                        ) {
                                            a.hasClass("sp-image") &&
                                                ((d.$mainImage = a),
        ...
        var c = "LazyLoading." + b.SliderPro.namespace,
            d = {
                ...
                _checkAndLoadVisibleImages: function () {
                    if (
                        0 !==
                        this.$slider.find(".sp-slide:not([ data-loaded ])")
                            .length
                    ) {
                        var a = this,
                            c =
                ...
                _checkAndLoadVisibleThumbnailImages: function () {
                    if (
                        ...
                        var a = this,
                            ...
                            d = Math.floor(
                                Math.abs(this.thumbnailsPosition / c)
                            ),
                            e = Math.floor(
                                (-this.thumbnailsPosition +
                                    this.thumbnailsContainerSize) /
            ...
            d = {
                ...
                initLayers: function () {
                    this.on("update." + c, b.proxy(this._layersOnUpdate, this)),
                        ...
                        this.on(
                            "gotoSlide." + c,
                            b.proxy(this._layersOnGotoSlide, this)
                        );
                },
                                ...
                                ? (e++,
                                  e === d.length &&
                                      ...
                                      b.isFunction(
                                          ...
                                          c.settings.showLayersComplete.call(
                                              c,
                                              {
                                                  type: "showLayersComplete",
                                                  index: a,
                            ...
                            f.isVisible() === !1
                                ? (e++,
                                  e === d.length &&
                                      ...
                                      b.isFunction(
                                          c.settings.hideLayersComplete
                                      ) &&
                                          c.settings.hideLayersComplete.call(
                                              c,
                                              {
                                                  type: "hideLayersComplete",
                                                  index: a,
                            ...
                            b.each(this.slides, function (a, b) {
                                ...
                                this._fadeSlideTo(c, 1, function () {
                                    ...
                                    b.each(e.slides, function (a, b) {
                                        ...
                                        b.isFunction(
                                            e.settings.gotoSlideComplete
                                        ) &&
                                            e.settings.gotoSlideComplete.call(
                                                e,
                                                {
                                                    type: "gotoSlideComplete",
                                                    index: a,
            ...
            d = {
                ...
                initTouchSwipe: function () {
                    ...
                    this.settings.touchSwipe !== !1 &&
                        ...
                        this.$slidesMask
                            .find("a")
                            .on("click." + c, function (b) {
                                a.$slider.hasClass("sp-swiping") &&
                                    b.preventDefault();
                            }),
                ...
                _updateCaptionContent: function () {
                    ...
                    this.settings.fadeCaption === !0
                        ? "" !== this.captionContent
                            ? (0 ===
                                  parseFloat(
                                      this.$captionContainer.css("opacity"),
                                      10
                                  ) &&
        ...
        var c = "Autoplay." + b.SliderPro.namespace,
            d = {
                ...
                initAutoplay: function () {
                    this.on(
                        "update." + c,
                        b.proxy(this._autoplayOnUpdate, this)
                    );
                },
            ...
            d = {
                initKeyboard: function () {
                    ...
                    this.settings.keyboard !== !1 &&
                        ...
                        b(document).on(
                            "keydown." + this.uniqueId + "." + c,
                            function (b) {
                                if (
                                    a.settings.keyboardOnlyOnFocus !== !0 ||
                                    d !== !1
                                )
            ...
            d = {
                ...
                initFullScreen: function () {
                    (document.fullscreenEnabled ||
                        ...
                        this.on(
                            "update." + c,
                            b.proxy(this._fullScreenOnUpdate, this)
                        );
                },
        ...
        var c = "Buttons." + b.SliderPro.namespace,
            d = {
                ...
                initButtons: function () {
                    this.on(
                        "update." + c,
                        b.proxy(this._buttonsOnUpdate, this)
                    );
                },
                ...
                _createButtons: function () {
                    ...
                    for (var d = 0; d < this.getTotalSlides(); d++)
                        b('<div class="sp-button"></div>').appendTo(
                            this.$buttons
                        );
            ...
            d = {
                ...
                _onThumbnailTouchMove: function (a) {
                    ...
                    if (Math.abs(c) > Math.abs(d)) {
                        if (
                            (a.preventDefault(), this.thumbnailsPosition >= 0)
                        ) {
                        ...
                        this._moveThumbnailsTo(
                            this.thumbnailTouchStartPosition + c,
                            !0
                        );
                    }
                },
                            ...
                            ? ((this.$thumbnailArrows = b(
                              ...
                              this.$previousThumbnailArrow.on(
                                  ...
                                  function () {
                                      var b = Math.min(
                                          0,
                                          a.thumbnailsPosition +
                                              a.thumbnailsContainerSize
                                      );
            ...
            d = {
                ...
                initVideo: function () {
                    this.on("update." + c, b.proxy(this._videoOnUpdate, this)),
                        this.on(
                            "gotoSlide." + c,
                            b.proxy(this._videoOnGotoSlide, this)
                        ),
                        this.on(
                            "gotoSlideComplete." + c,
            ...
            _init: function () {
                ...
                if (null !== this.player) {
                    ...
                    a.each(f, function (c, e) {
                        var f =
                            "video" + e.charAt(0).toUpperCase() + e.slice(1);
        ...
        (f.prototype = new d()),
            ...
            (f.prototype.play = function () {
                ...
                if (this.ready === !0) this.player.playVideo();
                    ...
                    var b = setInterval(function () {
                        a.ready === !0 &&
                            (clearInterval(b), a.player.playVideo());
                    }, 100);
            }),
            ...
            (f.prototype.on = function (a, b) {
                ...
                if (this.init === !0) d.prototype.on.call(this, a, b);
                    ...
                    var e = setInterval(function () {
                        c.init === !0 &&
                            (clearInterval(e), d.prototype.on.call(c, a, b));
                    }, 100);
            });
        ...
        (l.prototype = new d()),
            ...
            (l.prototype._init = function () {
                ...
                this.$video.hasClass("jwplayer")
                    ...
                    : 0 !==
                          this.$video.find("object[data*='jwplayer']").length &&
